...
$sql="SELECT * FROM Donner WHERE is_request=0";
?>
  <main id="main">
...
<section class="inner-page">
  <div class="container">
    <a class="btn btn-success" href="request.php">Donner request</a>
    <a class="btn btn-success" href="add_donner.php">Add Donner</a>
